  ...
  return (
    <View className="flex-1 mt-16">
       <ProgressSteps {...progressStepsStyle}>
        ...
        <ProgressStep label="Step 1" nextBtnTextStyle={buttonNext}>
          <View className="flex-1 justify-center items-center">
            <TouchableOpacity
              className={`bg-gray-200 rounded-md p-3 m-2 ${selectedSkinType === 'Dry' && 'bg-blue-500'}`}
              onPress={() => setSelectedSkinType('Dry')}
            >
              <Text className={`text-lg font-semibold ${selectedSkinType === 'Dry' ? 'text-white' : 'text-black'}`}>Dry</Text>
            </TouchableOpacity>
            <TouchableOpacity
              className={`bg-gray-200 rounded-md p-3 m-2 ${selectedSkinType === 'Normal' && 'bg-blue-500'}`}
              onPress={() => setSelectedSkinType('Normal')}
            >
              <Text className={`text-lg font-semibold ${selectedSkinType === 'Normal' ? 'text-white' : 'text-black'}`}>Normal</Text>
            </TouchableOpacity>
            <TouchableOpacity
              className={`bg-gray-200 rounded-md p-3 m-2 ${selectedSkinType === 'Oily' && 'bg-blue-500'}`}
            ...
            <TouchableOpacity
              className={`bg-gray-200 rounded-md p-3 m-2 ${selectedSkinType === 'Combination' && 'bg-blue-500'}`}
        ...
        <ProgressStep label="Step 2" onSubmit={handleSavePreferences} previousBtnTextStyle={buttonPrevious} finishBtnText="Submit">
          <View className="p-4">
            <TouchableOpacity
